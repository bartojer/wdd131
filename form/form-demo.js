...
function validateForm(event) {
    ...
    function togglePaymentDetails(e) {
        ...
        const creditCardContainer = theForm.querySelector("#credit");
        const paypalContainer = theForm.querySelector("#paypal");

        
        // Hide payment containers by adding the '.hide' class to each of them
        choice = e.target.value;
        creditInput = document.querySelector("#paypal-username");
        paypalInput = document.querySelector("#credit-card-number");
        ...
        if (choice === "credit") {
            ...
            creditInput.setAttribute("requred", "");
        } else {
    ...
    document.querySelector("#payment_method").addEventListener("change", togglePaymentDetails)
